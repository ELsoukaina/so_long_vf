...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/06/26 20:17:18 by sel-jala          #+#    #+#             */
/*   Updated: 2022/09/27 17:17:44 by sel-jala         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_xpm_file_to_image(t_map *data)
{
	...
	data->heart_image = mlx_xpm_file_to_image(data->mlx, \
		"./images_mandatory/heart.XPM", &data->width, &data->height);
...
void	ft_put_image_to_window(t_map *data)
{
	...
	if (data->map[data->i][data->j] == 'C')
		mlx_put_image_to_window(data->mlx, data->mlx_win, \
			data->heart_image, data->w, IMG_SIZE * data->i);
